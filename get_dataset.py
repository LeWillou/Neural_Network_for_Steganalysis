...
for directory_name in directories[0]:
    for audio_file in audio_files[1]:
        ...
        file_freq_peaks.append(check_peaks.check_peaks('wav_stego/' + directory_name + '/' + audio_file))
        file_phases.append(check_phase.check_phase('wav_stego/' + directory_name + '/' + audio_file))
        file_samples_peaks.append(check_samples.check_peaks_sample('wav_stego/' + directory_name + '/' + audio_file))
        ...
        counter += 1
        percentage_done = (counter/320)*100
...
np.save('dataset_training_320', dataset)
